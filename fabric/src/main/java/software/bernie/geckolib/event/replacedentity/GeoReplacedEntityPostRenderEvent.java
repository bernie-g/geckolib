 ...
 * @see Post
 */
public class GeoReplacedEntityPostRenderEvent<T extends GeoAnimatable, E extends Entity, R extends EntityRenderState & GeoRenderState> implements GeoRenderEvent.ReplacedEntity.Post<T, E, R> {
    ...
    public interface Listener<T extends GeoAnimatable, E extends net.minecraft.world.entity.Entity, R extends EntityRenderState & GeoRenderState>  {
        void handle(GeoReplacedEntityPostRenderEvent<T, E, R> event);
    }
}
