...
public class EntityRegistry {
    ...
    public static <T extends Mob> EntityType<T> registerMob(String name, EntityType.EntityFactory<T> entity,
        ...
        EntityType<T> entityType = FabricEntityTypeBuilder.<T>create(MobCategory.CREATURE).entityFactory(entity).dimensions(new EntityDimensions(width, height, false)).build();
