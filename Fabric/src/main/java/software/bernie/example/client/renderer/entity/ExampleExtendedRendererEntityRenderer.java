...
public class ExampleExtendedRendererEntityRenderer extends ExtendedGeoEntityRenderer<ExtendedRendererEntity> {
	...
	public ExampleExtendedRendererEntityRenderer(EntityRenderDispatcher renderManager) {
		super(renderManager, new ExampleExtendedRendererEntityModel<ExtendedRendererEntity>(
				EntityResources.EXTENDED_MODEL, EntityResources.EXTENDED_TEXTURE, "extendedrendererentity"));
	}
