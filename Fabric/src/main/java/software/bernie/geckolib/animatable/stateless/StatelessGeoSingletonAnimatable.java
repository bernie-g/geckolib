...
public non-sealed interface StatelessGeoSingletonAnimatable extends StatelessAnimatable, SingletonGeoAnimatable {
    ...
    default void playAnimation(RawAnimation animation, Entity relatedEntity, long instanceId) {
        if (relatedEntity.level().isClientSide) {
            ...
            GeckoLibNetwork.sendToTrackingEntityAndSelf(new StatelessSingletonPlayAnimPacket(GeckoLibNetwork.getSyncedSingletonAnimatableId(this), instanceId, animation), relatedEntity);
        }
    }
    ...
    default void stopAnimation(String animation, Entity relatedEntity, long instanceId) {
        if (relatedEntity.level().isClientSide) {
            ...
            GeckoLibNetwork.sendToTrackingEntityAndSelf(new StatelessSingletonStopAnimPacket(GeckoLibNetwork.getSyncedSingletonAnimatableId(this), instanceId, animation), relatedEntity);
        }
    }
