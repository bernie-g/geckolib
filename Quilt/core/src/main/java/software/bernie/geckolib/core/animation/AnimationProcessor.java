...
public class AnimationProcessor<T extends GeoAnimatable> {
	 ...
	 * @param state                 An {@link AnimationEvent} instance applied to this render frame
	 * @param crashWhenCantFindBone Whether to crash if unable to find a required bone, or to continue with the remaining bones
	 */
	public void tickAnimation(T animatable, CoreGeoModel<T> model, AnimatableManager<T> animatableManager, double animTime, AnimationEvent<T> state, boolean crashWhenCantFindBone) {
