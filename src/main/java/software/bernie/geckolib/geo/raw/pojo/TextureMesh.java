...
public class TextureMesh {
    ...
    /**
     * The pivot point on the texture (in *texture space* not entity or bone space) of the
     * texture geometry
     */
    @JsonProperty("local_pivot")
    public double[] getLocalPivot() { return localPivot; }
    @JsonProperty("local_pivot")
    public void setLocalPivot(double[] value) { this.localPivot = value; }

    /**
     * The position of the pivot point after rotation (in *entity space* not texture or bone
     * space) of the texture geometry
     */
    ...
    @JsonProperty("texture")
    public void setTexture(String value) { this.texture = value; }
}
