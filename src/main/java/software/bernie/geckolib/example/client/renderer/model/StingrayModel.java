...
public class StingrayModel extends AnimatedEntityModel<StingrayTestEntity>
{
	...
	public StingrayModel()
	{
		...
		Stingray.setPivot(2.0F, 24.0F, 12.0F);
		Stingray.setTextureOffset(6, 6).addCuboid(1.0F, -5.0F, -19.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		Stingray.setTextureOffset(0, 4).addCuboid(-7.0F, -5.0F, -19.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		Stingray.setModelRendererName("Stingray");

		Body = new AnimatedModelRenderer(this);
		Body.setPivot(-2.0F, 0.0F, -12.0F);
		Stingray.addChild(Body);
		Body.setTextureOffset(70, 41).addCuboid(-4.0F, -2.0F, -8.0F, 8.0F, 2.0F, 16.0F, 0.0F, false);
		Body.setTextureOffset(0, 36).addCuboid(-5.0F, -4.0F, -8.0F, 10.0F, 2.0F, 16.0F, 0.0F, false);
		Body.setTextureOffset(50, 18).addCuboid(-7.0F, -3.0F, -10.0F, 14.0F, 2.0F, 2.0F, 0.0F, false);
		Body.setModelRendererName("Body");

		mouth = new AnimatedModelRenderer(this);
		mouth.setPivot(0.0F, -2.0F, -2.0F);
		Body.addChild(mouth);
		setRotationAngle(mouth, 1.8326F, 0.0F, 0.0F);
		mouth.setTextureOffset(50, 22).addCuboid(-2.0F, -2.2251F, -2.6648F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		mouth.setModelRendererName("mouth");

		Lefthand = new AnimatedModelRenderer(this);
		Lefthand.setPivot(-4.0F, -0.75F, 0.0F);
		Body.addChild(Lefthand);
		Lefthand.setTextureOffset(4, 18).addCuboid(-13.0F, -1.25F, -8.0F, 13.0F, 2.0F, 16.0F, 0.0F, false);
		Lefthand.setModelRendererName("Lefthand");

		smallfinleft = new AnimatedModelRenderer(this);
		smallfinleft.setPivot(-12.0F, 0.75F, 0.0F);
		Lefthand.addChild(smallfinleft);
		smallfinleft.setTextureOffset(50, 0).addCuboid(-5.0F, -2.0F, -6.0F, 4.0F, 2.0F, 12.0F, 0.0F, false);
		smallfinleft.setModelRendererName("smallfinleft");

		Righthand = new AnimatedModelRenderer(this);
		Righthand.setPivot(4.0F, -0.75F, 0.0F);
		Body.addChild(Righthand);
		Righthand.setTextureOffset(4, 0).addCuboid(0.0F, -1.25F, -8.0F, 13.0F, 2.0F, 16.0F, 0.0F, false);
		Righthand.setModelRendererName("Righthand");

		smallfinright = new AnimatedModelRenderer(this);
		smallfinright.setPivot(13.0F, 0.75F, 0.0F);
		Righthand.addChild(smallfinright);
		smallfinright.setTextureOffset(38, 38).addCuboid(0.0F, -2.0F, -6.0F, 4.0F, 2.0F, 12.0F, 0.0F, false);
		smallfinright.setModelRendererName("smallfinright");

		Tail = new AnimatedModelRenderer(this);
		Tail.setPivot(-2.0F, -2.0F, -4.0F);
		Stingray.addChild(Tail);
		Tail.setModelRendererName("Tail");

		tail1 = new AnimatedModelRenderer(this);
		tail1.setPivot(1.0F, 2.0F, -1.0F);
		Tail.addChild(tail1);
		tail1.setTextureOffset(20, 54).addCuboid(-3.0F, -4.0F, 1.0F, 4.0F, 4.0F, 6.0F, 0.0F, false);
		tail1.setModelRendererName("tail1");

		tail2 = new AnimatedModelRenderer(this);
		tail2.setPivot(0.0F, 1.0F, 6.0F);
		Tail.addChild(tail2);
		tail2.setModelRendererName("tail2");

		tail3 = new AnimatedModelRenderer(this);
		tail3.setPivot(0.0F, 0.0F, 12.0F);
		Tail.addChild(tail3);
		tail3.setModelRendererName("tail3");

		tail4 = new AnimatedModelRenderer(this);
		tail4.setPivot(0.0F, 0.0F, 18.0F);
		Tail.addChild(tail4);
		tail4.setModelRendererName("tail4");

		stinger = new AnimatedModelRenderer(this);
		stinger.setPivot(0.0F, 0.5F, 5.5F);
		tail4.addChild(stinger);
		stinger.setModelRendererName("stinger");

		bone = new AnimatedModelRenderer(this);
		bone.setPivot(0.1057F, -0.4766F, -17.75F);
		stinger.addChild(bone);
		bone.setTextureOffset(34, 58).addCuboid(-2.1057F, -2.0234F, 0.25F, 4.0F, 4.0F, 6.0F, 0.0F, false);
		bone.setModelRendererName("bone");

		AllExcept12 = new AnimatedModelRenderer(this);
		AllExcept12.setPivot(0.067F, 0.0703F, 6.0F);
		bone.addChild(AllExcept12);
		AllExcept12.setTextureOffset(0, 54).addCuboid(-2.1726F, -2.0937F, 0.25F, 4.0F, 4.0F, 6.0F, 0.0F, false);
		AllExcept12.setModelRendererName("AllExcept12");

		AllExcept123 = new AnimatedModelRenderer(this);
		AllExcept123.setPivot(0.0F, 0.25F, 6.25F);
		AllExcept12.addChild(AllExcept123);
		AllExcept123.setTextureOffset(48, 52).addCuboid(-2.1726F, -2.3437F, 0.0F, 4.0F, 4.0F, 6.0F, 0.0F, false);
		AllExcept123.setTextureOffset(11, 80).addCuboid(-0.75F, -1.25F, 6.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
	...
	{
		return new Identifier("geckolib:animations/stingrayanimation.json");
	}
