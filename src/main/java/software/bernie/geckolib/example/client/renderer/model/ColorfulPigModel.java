...
public class ColorfulPigModel extends AnimatedEntityModel<EntityColorfulPig> {
	...
	public ColorfulPigModel()
	{
		...
		Body.setTextureOffset(0, 0).addCuboid(-6.0F, -6.0F, -10.0F, 12.0F, 8.0F, 18.0F, 0.0F, false);
		...
		RightBack.setPivot(-5.0F, 2.0F, 7.0F);
		Back.addChild(RightBack);
		RightBack.setTextureOffset(0, 0).addCuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, 0.0F, false);
		RightBack.setModelRendererName("RightBack");
		this.registerModelRenderer(RightBack);

		LeftBack = new AnimatedModelRenderer(this);
		LeftBack.setPivot(5.0F, 2.0F, 7.0F);
		Back.addChild(LeftBack);
		LeftBack.setTextureOffset(6, 6).addCuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, 0.0F, false);
		...
		RightFront.setPivot(-5.0F, 2.0F, -9.0F);
		Front.addChild(RightFront);
		RightFront.setTextureOffset(24, 26).addCuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, 0.0F, false);
		RightFront.setModelRendererName("RightFront");
		this.registerModelRenderer(RightFront);

		LeftFront = new AnimatedModelRenderer(this);
		LeftFront.setPivot(5.0F, 2.0F, -9.0F);
		Front.addChild(LeftFront);
		LeftFront.setTextureOffset(30, 32).addCuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, 0.0F, false);
		LeftFront.setModelRendererName("LeftFront");
		this.registerModelRenderer(LeftFront);

		Head = new AnimatedModelRenderer(this);
		Head.setPivot(0.0F, -5.0F, -10.0F);
		Body.addChild(Head);
		Head.setTextureOffset(0, 26).addCuboid(-3.0F, -4.0F, -6.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
	...
	{
		return new Identifier("geckolib", "animations/colorfulpig.json");
	}
}