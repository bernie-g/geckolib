...
public class BrownModel extends AnimatedEntityModel<BrownEntity>
{
	...
	public BrownModel()
	{
		...
		all.setPivot(0.0F, -16.0F, 0.0F);

		all.setModelRendererName("all");
		this.registerModelRenderer(all);

		rightleg = new AnimatedModelRenderer(this);
		rightleg.setPivot(4.0F, 0.0F, 0.0F);
		all.addChild(rightleg);
		rightleg.setTextureOffset(66, 66).addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 18.0F, 4.0F, 0.0F, false);
		rightleg.setModelRendererName("rightleg");
		this.registerModelRenderer(rightleg);

		rightleg3 = new AnimatedModelRenderer(this);
		rightleg3.setPivot(0.0F, 18.0F, 0.0F);
		rightleg.addChild(rightleg3);
		rightleg3.setTextureOffset(82, 82).addCuboid(-2.0F, 0.0F, -2.0F, 1.0F, 21.0F, 4.0F, 0.0F, false);
		rightleg3.setTextureOffset(48, 81).addCuboid(1.0F, 0.0F, -2.0F, 1.0F, 21.0F, 4.0F, 0.0F, false);
		rightleg3.setTextureOffset(54, 112).addCuboid(-1.0F, 19.0F, -2.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);
		rightleg3.setTextureOffset(101, 110).addCuboid(-1.0F, 0.0F, -2.0F, 2.0F, 3.0F, 4.0F, 0.0F, false);
		rightleg3.setModelRendererName("rightleg3");
		this.registerModelRenderer(rightleg3);

		right_feet = new AnimatedModelRenderer(this);
		right_feet.setPivot(0.0F, 21.0F, 0.0F);
		rightleg3.addChild(right_feet);
		right_feet.setTextureOffset(35, 0).addCuboid(-2.4F, 0.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.001F, false);
		right_feet.setTextureOffset(42, 5).addCuboid(1.0F, 0.0F, -6.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		right_feet.setTextureOffset(26, 114).addCuboid(-1.0F, 0.0F, -6.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		right_feet.setTextureOffset(36, 114).addCuboid(-3.0F, 0.0F, -5.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		right_feet.setModelRendererName("right_feet");
		this.registerModelRenderer(right_feet);

		leftleg = new AnimatedModelRenderer(this);
		leftleg.setPivot(-4.0F, 0.0F, 0.0F);
		all.addChild(leftleg);
		leftleg.setTextureOffset(0, 61).addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 18.0F, 4.0F, 0.0F, false);
		leftleg.setModelRendererName("leftleg");
		this.registerModelRenderer(leftleg);

		leftleg2 = new AnimatedModelRenderer(this);
		leftleg2.setPivot(0.0F, 18.0F, 0.0F);
		leftleg.addChild(leftleg2);
		leftleg2.setTextureOffset(72, 20).addCuboid(-2.0F, 0.0F, -2.0F, 1.0F, 21.0F, 4.0F, 0.0F, false);
		leftleg2.setTextureOffset(16, 61).addCuboid(1.0F, 0.0F, -2.0F, 1.0F, 21.0F, 4.0F, 0.0F, false);
		leftleg2.setTextureOffset(111, 46).addCuboid(-1.0F, 19.0F, -2.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);
		leftleg2.setTextureOffset(89, 110).addCuboid(-1.0F, 0.0F, -2.0F, 2.0F, 3.0F, 4.0F, 0.0F, false);
		leftleg2.setModelRendererName("leftleg2");
		this.registerModelRenderer(leftleg2);

		left_feet = new AnimatedModelRenderer(this);
		left_feet.setPivot(0.0F, 21.0F, 0.0F);
		leftleg2.addChild(left_feet);
		left_feet.setTextureOffset(66, 0).addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.001F, false);
		left_feet.setTextureOffset(49, 25).addCuboid(-2.0F, 0.0F, -6.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		left_feet.setTextureOffset(78, 62).addCuboid(0.0F, 0.0F, -6.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		left_feet.setTextureOffset(37, 87).addCuboid(2.0F, 0.0F, -5.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		left_feet.setModelRendererName("left_feet");
		this.registerModelRenderer(left_feet);

		slam = new AnimatedModelRenderer(this);
		slam.setPivot(0.0F, 28.0F, 0.0F);
		all.addChild(slam);
		slam.setTextureOffset(124, 126).addCuboid(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		slam.setModelRendererName("slam");
		this.registerModelRenderer(slam);

		warn = new AnimatedModelRenderer(this);
		warn.setPivot(0.0F, 17.0F, 0.0F);
		all.addChild(warn);
		warn.setTextureOffset(124, 126).addCuboid(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		all.addChild(body);
		body.setTextureOffset(65, 5).addCuboid(-6.0F, -7.0F, -3.0F, 4.0F, 7.0F, 7.0F, 0.0F, false);
		body.setTextureOffset(63, 46).addCuboid(2.0F, -7.0F, -3.0F, 4.0F, 7.0F, 7.0F, 0.0F, false);
		body.setTextureOffset(78, 39).addCuboid(-2.0F, -7.0F, -2.0F, 4.0F, 7.0F, 6.0F, 0.0F, false);
		body.setModelRendererName("body");
		this.registerModelRenderer(body);

		body2 = new AnimatedModelRenderer(this);
		body2.setPivot(0.0F, -8.0F, 0.0F);
		body.addChild(body2);
		body2.setTextureOffset(32, 32).addCuboid(-4.0F, -8.0F, -2.0F, 9.0F, 9.0F, 5.0F, 0.0F, false);
		body2.setModelRendererName("body2");
		this.registerModelRenderer(body2);

		body3 = new AnimatedModelRenderer(this);
		body3.setPivot(0.0F, -8.0F, 0.0F);
		body2.addChild(body3);
		body3.setTextureOffset(0, 0).addCuboid(-7.0F, -17.0F, -3.0F, 14.0F, 17.0F, 7.0F, 0.0F, false);
		body3.setTextureOffset(0, 93).addCuboid(-1.2F, -16.0F, -4.0F, 2.0F, 13.0F, 1.0F, 0.0F, false);
		body3.setTextureOffset(58, 85).addCuboid(-1.0F, -17.0F, 4.0F, 2.0F, 17.0F, 1.0F, 0.0F, false);
		body3.setTextureOffset(70, 111).addCuboid(7.0F, -17.0F, -2.0F, 1.0F, 4.0F, 4.0F, 0.0F, false);
		body3.setTextureOffset(16, 111).addCuboid(-8.0F, -17.0F, -2.0F, 1.0F, 4.0F, 4.0F, 0.0F, false);
		body3.setModelRendererName("body3");
		this.registerModelRenderer(body3);

		rightarm = new AnimatedModelRenderer(this);
		rightarm.setPivot(9.0F, -14.5F, 0.0F);
		body3.addChild(rightarm);
		rightarm.setTextureOffset(16, 24).addCuboid(-1.0F, -2.5F, -2.0F, 4.0F, 33.0F, 4.0F, 0.0F, false);
		rightarm.setModelRendererName("rightarm");
		this.registerModelRenderer(rightarm);

		rightarm2 = new AnimatedModelRenderer(this);
		rightarm2.setPivot(1.0F, 30.5F, 0.0F);
		rightarm.addChild(rightarm2);
		rightarm2.setTextureOffset(60, 24).addCuboid(-2.0F, 0.0F, -2.0F, 1.0F, 25.0F, 4.0F, 0.0F, false);
		rightarm2.setTextureOffset(28, 58).addCuboid(1.0F, 0.0F, -2.0F, 1.0F, 25.0F, 4.0F, 0.0F, false);
		rightarm2.setTextureOffset(42, 110).addCuboid(-1.0F, 22.0F, -2.0F, 2.0F, 3.0F, 4.0F, 0.0F, false);
		rightarm2.setTextureOffset(92, 92).addCuboid(-1.0F, 0.0F, -2.0F, 2.0F, 6.0F, 4.0F, 0.0F, false);
		rightarm2.setModelRendererName("rightarm2");
		this.registerModelRenderer(rightarm2);

		righthand = new AnimatedModelRenderer(this);
		righthand.setPivot(0.0F, 25.0F, 0.0F);
		rightarm2.addChild(righthand);
		righthand.setTextureOffset(113, 113).addCuboid(-2.0F, 0.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);
		righthand.setModelRendererName("righthand");
		this.registerModelRenderer(righthand);

		righthand2 = new AnimatedModelRenderer(this);
		righthand2.setPivot(1.5F, 3.0F, -0.5F);
		righthand.addChild(righthand2);
		setRotationAngle(righthand2, 0.1745F, 0.0F, -0.1745F);
		righthand2.setTextureOffset(16, 24).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		righthand2.setModelRendererName("righthand2");
		this.registerModelRenderer(righthand2);

		righthand7 = new AnimatedModelRenderer(this);
		righthand7.setPivot(0.0F, 1.0F, 0.0F);
		righthand2.addChild(righthand7);
		setRotationAngle(righthand7, 0.2618F, 0.0F, 0.0F);
		righthand7.setTextureOffset(55, 33).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		righthand7.setModelRendererName("righthand7");
		this.registerModelRenderer(righthand7);

		righthand3 = new AnimatedModelRenderer(this);
		righthand3.setPivot(0.5F, 3.0F, -0.5F);
		righthand.addChild(righthand3);
		setRotationAngle(righthand3, 0.1745F, 0.0F, -0.0873F);
		righthand3.setTextureOffset(55, 30).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		righthand3.setModelRendererName("righthand3");
		this.registerModelRenderer(righthand3);

		righthand8 = new AnimatedModelRenderer(this);
		righthand8.setPivot(0.0F, 1.5F, 0.0F);
		righthand3.addChild(righthand8);
		setRotationAngle(righthand8, 0.1745F, 0.0F, 0.0F);
		righthand8.setTextureOffset(49, 49).addCuboid(-0.5F, -0.5F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		righthand8.setModelRendererName("righthand8");
		this.registerModelRenderer(righthand8);

		righthand4 = new AnimatedModelRenderer(this);
		righthand4.setPivot(-0.5F, 3.0F, -0.5F);
		righthand.addChild(righthand4);
		setRotationAngle(righthand4, 0.0873F, 0.0F, 0.0F);
		righthand4.setTextureOffset(48, 5).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		righthand4.setModelRendererName("righthand4");
		this.registerModelRenderer(righthand4);

		righthand9 = new AnimatedModelRenderer(this);
		righthand9.setPivot(0.0F, 2.5F, 0.0F);
		righthand4.addChild(righthand9);
		setRotationAngle(righthand9, 0.2618F, 0.0F, 0.0F);
		righthand9.setTextureOffset(42, 5).addCuboid(-0.5F, -0.5F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		righthand9.setModelRendererName("righthand9");
		this.registerModelRenderer(righthand9);

		righthand5 = new AnimatedModelRenderer(this);
		righthand5.setPivot(-1.5F, 3.0F, -0.5F);
		righthand.addChild(righthand5);
		setRotationAngle(righthand5, 0.0F, 0.0F, 0.1745F);
		righthand5.setTextureOffset(55, 25).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		...
		righthand10.setPivot(0.0F, 1.5F, 0.0F);
		righthand5.addChild(righthand10);
		setRotationAngle(righthand10, 0.2618F, 0.0F, 0.0F);
		righthand10.setTextureOffset(35, 0).addCuboid(-0.5F, -0.5F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		...
		righthand6.setPivot(-2.0F, 1.0F, 0.0F);
		righthand.addChild(righthand6);
		setRotationAngle(righthand6, 0.0F, 0.0F, 0.1745F);
		righthand6.setTextureOffset(47, 0).addCuboid(-1.0F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
		...
		head.setPivot(0.0F, -16.75F, 0.5F);
		body3.addChild(head);
		head.setTextureOffset(32, 25).addCuboid(-3.0F, -1.25F, -2.5F, 6.0F, 1.0F, 5.0F, 0.0F, false);
		head.setTextureOffset(48, 58).addCuboid(-1.0F, -21.25F, -1.0F, 2.0F, 20.0F, 2.0F, 0.0F, false);
		head.setModelRendererName("head");
		this.registerModelRenderer(head);

		siren1 = new AnimatedModelRenderer(this);
		siren1.setPivot(2.0385F, -9.25F, 0.0F);
		head.addChild(siren1);
		siren1.setTextureOffset(92, 82).addCuboid(-1.0385F, -3.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.0F, false);
		siren1.setTextureOffset(92, 117).addCuboid(1.9615F, -3.0F, -3.5F, 1.0F, 6.0F, 2.0F, 0.0F, false);
		siren1.setTextureOffset(8, 111).addCuboid(4.9615F, -5.0F, -5.5F, 3.0F, 10.0F, 1.0F, 0.0F, false);
		siren1.setTextureOffset(86, 117).addCuboid(1.9615F, -3.0F, 1.5F, 1.0F, 6.0F, 2.0F, 0.0F, false);
		siren1.setTextureOffset(0, 111).addCuboid(4.9615F, -5.0F, 4.5F, 3.0F, 10.0F, 1.0F, 0.0F, false);
		siren1.setTextureOffset(46, 117).addCuboid(2.9615F, -4.0F, 3.5F, 2.0F, 8.0F, 1.0F, 0.0F, false);
		siren1.setTextureOffset(80, 114).addCuboid(2.9615F, -4.0F, -4.5F, 2.0F, 8.0F, 1.0F, 0.0F, false);
		siren1.setTextureOffset(64, 88).addCuboid(1.9615F, -4.0F, -3.5F, 1.0F, 1.0F, 7.0F, 0.0F, false);
		siren1.setTextureOffset(48, 12).addCuboid(4.9615F, -6.0F, -5.5F, 3.0F, 1.0F, 11.0F, 0.0F, false);
		siren1.setTextureOffset(32, 46).addCuboid(4.9615F, 5.0F, -5.5F, 3.0F, 1.0F, 11.0F, 0.0F, false);
		siren1.setTextureOffset(82, 20).addCuboid(2.9615F, 4.0F, -4.5F, 2.0F, 1.0F, 9.0F, 0.0F, false);
		siren1.setTextureOffset(80, 0).addCuboid(2.9615F, -5.0F, -4.5F, 2.0F, 1.0F, 9.0F, 0.0F, false);
		siren1.setTextureOffset(28, 87).addCuboid(1.9615F, 3.0F, -3.5F, 1.0F, 1.0F, 7.0F, 0.0F, false);
		siren1.setModelRendererName("siren1");
		this.registerModelRenderer(siren1);

		teeth2 = new AnimatedModelRenderer(this);
		teeth2.setPivot(3.9615F, 4.0F, 0.0F);
		siren1.addChild(teeth2);
		teeth2.setTextureOffset(82, 72).addCuboid(-1.0F, -3.0F, -3.5F, 2.0F, 3.0F, 7.0F, 0.0F, false);
		teeth2.setModelRendererName("teeth2");
		this.registerModelRenderer(teeth2);

		teeth = new AnimatedModelRenderer(this);
		teeth.setPivot(3.9615F, -4.0F, 0.0F);
		siren1.addChild(teeth);
		teeth.setTextureOffset(82, 62).addCuboid(-1.0F, 0.0F, -3.5F, 2.0F, 3.0F, 7.0F, 0.0F, false);
		teeth.setModelRendererName("teeth");
		this.registerModelRenderer(teeth);

		siren2 = new AnimatedModelRenderer(this);
		siren2.setPivot(-1.9615F, -16.25F, 0.0F);
		head.addChild(siren2);
		setRotationAngle(siren2, 0.0F, 3.1416F, 0.0F);
		siren2.setTextureOffset(91, 10).addCuboid(-1.0385F, -3.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.0F, false);
		siren2.setTextureOffset(116, 74).addCuboid(1.9615F, -3.0F, -3.5F, 1.0F, 6.0F, 2.0F, 0.0F, false);
		siren2.setTextureOffset(48, 12).addCuboid(4.9615F, -5.0F, -5.5F, 3.0F, 10.0F, 1.0F, 0.0F, false);
		siren2.setTextureOffset(64, 116).addCuboid(1.9615F, -3.0F, 1.5F, 1.0F, 6.0F, 2.0F, 0.0F, false);
		siren2.setTextureOffset(32, 46).addCuboid(4.9615F, -5.0F, 4.5F, 3.0F, 10.0F, 1.0F, 0.0F, false);
		siren2.setTextureOffset(82, 20).addCuboid(2.9615F, -4.0F, 3.5F, 2.0F, 8.0F, 1.0F, 0.0F, false);
		siren2.setTextureOffset(82, 0).addCuboid(2.9615F, -4.0F, -4.5F, 2.0F, 8.0F, 1.0F, 0.0F, false);
		siren2.setTextureOffset(9, 86).addCuboid(1.9615F, -4.0F, -3.5F, 1.0F, 1.0F, 7.0F, 0.0F, false);
		siren2.setTextureOffset(42, 0).addCuboid(4.9615F, -6.0F, -5.5F, 3.0F, 1.0F, 11.0F, 0.0F, false);
		siren2.setTextureOffset(31, 13).addCuboid(4.9615F, 5.0F, -5.5F, 3.0F, 1.0F, 11.0F, 0.0F, false);
		siren2.setTextureOffset(78, 10).addCuboid(2.9615F, 4.0F, -4.5F, 2.0F, 1.0F, 9.0F, 0.0F, false);
		siren2.setTextureOffset(76, 52).addCuboid(2.9615F, -5.0F, -4.5F, 2.0F, 1.0F, 9.0F, 0.0F, false);
		siren2.setTextureOffset(82, 30).addCuboid(1.9615F, 3.0F, -3.5F, 1.0F, 1.0F, 7.0F, 0.0F, false);
		siren2.setModelRendererName("siren2");
		this.registerModelRenderer(siren2);

		teeth4 = new AnimatedModelRenderer(this);
		teeth4.setPivot(4.4615F, -4.0F, 0.0F);
		siren2.addChild(teeth4);
		teeth4.setTextureOffset(19, 80).addCuboid(-0.5F, 0.0F, -3.5F, 1.0F, 3.0F, 7.0F, 0.0F, false);
		teeth4.setModelRendererName("teeth4");
		this.registerModelRenderer(teeth4);

		teeth3 = new AnimatedModelRenderer(this);
		teeth3.setPivot(4.4615F, 4.0F, 0.0F);
		siren2.addChild(teeth3);
		teeth3.setTextureOffset(0, 83).addCuboid(-0.5F, -3.0F, -3.5F, 1.0F, 3.0F, 7.0F, 0.0F, false);
		teeth3.setModelRendererName("teeth3");
		this.registerModelRenderer(teeth3);

		leftarm = new AnimatedModelRenderer(this);
		leftarm.setPivot(-9.0F, -14.5F, 0.0F);
		body3.addChild(leftarm);
		leftarm.setTextureOffset(0, 24).addCuboid(-3.0F, -2.5F, -2.0F, 4.0F, 33.0F, 4.0F, 0.0F, false);
		leftarm.setModelRendererName("leftarm");
		this.registerModelRenderer(leftarm);

		leftarm2 = new AnimatedModelRenderer(this);
		leftarm2.setPivot(-1.0F, 30.5F, 0.0F);
		leftarm.addChild(leftarm2);
		leftarm2.setTextureOffset(38, 58).addCuboid(1.0F, 0.0F, -2.0F, 1.0F, 25.0F, 4.0F, 0.0F, false);
		leftarm2.setTextureOffset(62, 108).addCuboid(-1.0F, 22.0F, -2.0F, 2.0F, 3.0F, 4.0F, 0.0F, false);
		leftarm2.setTextureOffset(89, 52).addCuboid(-1.0F, 0.0F, -2.0F, 2.0F, 5.0F, 4.0F, 0.0F, false);
		leftarm2.setTextureOffset(56, 56).addCuboid(-2.0F, 0.0F, -2.0F, 1.0F, 25.0F, 4.0F, 0.0F, false);
		leftarm2.setModelRendererName("leftarm2");
		this.registerModelRenderer(leftarm2);

		lefthand = new AnimatedModelRenderer(this);
		lefthand.setPivot(0.0F, 25.5F, 0.0F);
		leftarm2.addChild(lefthand);
		lefthand.setTextureOffset(6, 94).addCuboid(-2.0F, -0.5F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);
		lefthand.setModelRendererName("lefthand");
		this.registerModelRenderer(lefthand);

		lefthand2 = new AnimatedModelRenderer(this);
		lefthand2.setPivot(1.5F, 2.5F, -0.5F);
		lefthand.addChild(lefthand2);
		setRotationAngle(lefthand2, 0.0F, 0.0F, -0.0873F);
		lefthand2.setTextureOffset(53, 46).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		lefthand2.setModelRendererName("lefthand2");
		this.registerModelRenderer(lefthand2);

		lefthand11 = new AnimatedModelRenderer(this);
		lefthand11.setPivot(0.0F, 1.4F, 0.0F);
		lefthand2.addChild(lefthand11);
		setRotationAngle(lefthand11, 0.2618F, 0.0F, 0.0F);
		lefthand11.setTextureOffset(32, 25).addCuboid(-0.5F, -0.4F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		lefthand11.setModelRendererName("lefthand11");
		this.registerModelRenderer(lefthand11);

		lefthand3 = new AnimatedModelRenderer(this);
		lefthand3.setPivot(0.5F, 2.5F, -0.5F);
		lefthand.addChild(lefthand3);
		lefthand3.setTextureOffset(32, 32).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		lefthand3.setModelRendererName("lefthand3");
		this.registerModelRenderer(lefthand3);

		lefthand10 = new AnimatedModelRenderer(this);
		lefthand10.setPivot(0.0F, 2.5F, 0.0F);
		lefthand3.addChild(lefthand10);
		setRotationAngle(lefthand10, 0.4363F, 0.0F, 0.0F);
		lefthand10.setTextureOffset(28, 24).addCuboid(-0.5F, -0.5F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		lefthand10.setModelRendererName("lefthand10");
		this.registerModelRenderer(lefthand10);

		lefthand4 = new AnimatedModelRenderer(this);
		lefthand4.setPivot(-0.5F, 2.5F, -0.5F);
		lefthand.addChild(lefthand4);
		setRotationAngle(lefthand4, 0.0F, 0.0F, 0.0873F);
		lefthand4.setTextureOffset(49, 46).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		lefthand4.setModelRendererName("lefthand4");
		this.registerModelRenderer(lefthand4);

		lefthand9 = new AnimatedModelRenderer(this);
		lefthand9.setPivot(0.0F, 1.5F, 0.0F);
		lefthand4.addChild(lefthand9);
		setRotationAngle(lefthand9, 0.5236F, 0.0F, 0.0F);
		lefthand9.setTextureOffset(0, 24).addCuboid(-0.5F, -0.5F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		lefthand9.setModelRendererName("lefthand9");
		this.registerModelRenderer(lefthand9);

		lefthand5 = new AnimatedModelRenderer(this);
		lefthand5.setPivot(-1.5F, 2.5F, -0.5F);
		lefthand.addChild(lefthand5);
		setRotationAngle(lefthand5, 0.0F, 0.0F, 0.1745F);
		lefthand5.setTextureOffset(0, 5).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		lefthand5.setModelRendererName("lefthand5");
		this.registerModelRenderer(lefthand5);

		lefthand8 = new AnimatedModelRenderer(this);
		lefthand8.setPivot(0.0F, 1.0F, 0.0F);
		lefthand5.addChild(lefthand8);
		setRotationAngle(lefthand8, 0.5236F, 0.0F, 0.0F);
		lefthand8.setTextureOffset(49, 25).addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		lefthand8.setModelRendererName("lefthand8");
		this.registerModelRenderer(lefthand8);

		lefthand6 = new AnimatedModelRenderer(this);
		lefthand6.setPivot(2.0F, 0.5F, -0.5F);
		lefthand.addChild(lefthand6);
		setRotationAngle(lefthand6, 0.0F, 0.0F, -0.1745F);
		lefthand6.setTextureOffset(12, 24).addCuboid(0.0F, 0.0F, -0.5F, 1.0F, 2.0F, 2.0F, 0.0F, false);
		lefthand6.setModelRendererName("lefthand6");
		this.registerModelRenderer(lefthand6);

		lefthand7 = new AnimatedModelRenderer(this);
		lefthand7.setPivot(0.5F, 1.5F, 0.0F);
		lefthand6.addChild(lefthand7);
		setRotationAngle(lefthand7, 0.4363F, 0.0F, 0.0F);
		lefthand7.setTextureOffset(0, 0).addCuboid(-0.5F, -0.5F, -0.5F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		lefthand7.setModelRendererName("lefthand7");
		this.registerModelRenderer(lefthand7);

		arm2 = new AnimatedModelRenderer(this);
		arm2.setPivot(0.0F, 0.0F, 0.0F);
		...
		cen_bone.setPivot(0.0F, -6.0F, -3.0F);
	...
	{
		return new Identifier("geckolib", "animations/brown.json");
	}
}