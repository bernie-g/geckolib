...
public record Operator(String symbol, int precedence, Operation operation) implements Comparable<Operator> {
    ...
    public static final Operator ASSIGN_VARIABLE = register("=", 1, (a, b) -> 0);
    public static final Operator OR = registerAlias(register("||", 2, (a, b) -> a != 0 || b != 0 ? 1 : 0),
                                                    "|");
    public static final Operator AND = registerAlias(register("&&", 3, (a, b) -> a != 0 && b != 0 ? 1 : 0),
                                                     "&");
    public static final Operator EQUAL = register("==", 4, (a, b) -> Math.abs(a - b) < 0.00001 ? 1 : 0);
    public static final Operator NOT_EQUAL = register("!=", 4, (a, b) -> Math.abs(a - b) >= 0.00001 ? 1 : 0);
    ...
    public static final Operator ADD = register("+", 6, Double::sum);
    public static final Operator SUB = register("-", 6, (a, b) -> a - b);
    public static final Operator MUL = register("*", 7, (a, b) -> a * b);
    public static final Operator DIV = register("/", 7, (a, b) -> b == 0 ? a : a / b);
    public static final Operator MOD = register("%", 7, (a, b) -> b == 0 ? a : a % b);
    public static final Operator POW = register("^", 8, Math::pow);
     ...
     *
     * @param original The target operator these aliases are for
     * @param aliases The list of alias symbols for this operator
