 ...
 * <p>
 * Note that the timestamp for this effect isn't contained here, but instead in the {@link ActorAnimation#soundEffects()} map
 * <p>
...
public record ActorAnimationSoundEffect(String effect, @Nullable String locator, @Nullable String preEffectScript, @Nullable Boolean bindToActor) {
    /**
     * Parse an ActorAnimationSoundEffect instance from raw .json input via {@link Gson}
     */
