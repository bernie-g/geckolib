...
/// Context-aware wrapper for [AnimatableManager]
///
/// This can be used for things like perspective-dependent animation handling and other similar functionality
///
/// This relies entirely on data present in [AnimatableManager#getAnimatableData] saved to this manager to determine context
///
...
public abstract class ContextAwareAnimatableManager<T extends GeoAnimatable, C> extends AnimatableManager<T> {
	...
	///
	/// You probably should have added it during [GeoAnimatable#registerControllers] instead
