...
/// Base interface for a container for [GeoRenderLayers][GeoRenderLayer]
///
...
/// @param <O> Associated object class type, or [Void] if none. Inherited from the renderer this container belongs to
...
public class GeoRenderLayersContainer<T extends GeoAnimatable, O, R extends GeoRenderState> {
	...
	/// Get the [GeoRenderLayer] list for usage
	...
	/// Create and fire the relevant `CompileRenderLayers` event hook for the owning renderer
