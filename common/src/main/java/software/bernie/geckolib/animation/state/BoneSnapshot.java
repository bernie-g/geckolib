...
/**
 * A state container for a single {@link GeoBone}'s animation transformations.
 * <p>
...
public class BoneSnapshot {
    ...
    /**
     * Set the x/y/z rotation values<br>
    ...
    /**
     * Set the x-axis rotation value<br>
     * Value is in radians
     */
    ...
    /**
     * Set the y-axis rotation value<br>
     *      * Value is in radians
     */
    ...
    /**
     * Set the z-axis rotation value<br>
     *      * Value is in radians
     */
     ...
     * <p>
     * NOTE: This bone's children will still render unless {@link #skipChildrenRender(boolean)} is set to true
     */
