...
public class GeckoLibEventsForge implements GeckoLibEvents {
    ...
    boolean fireItemPreRender(RenderPassInfo<GeoRenderState> renderPassInfo, SubmitNodeCollector renderTasks) {
        return !GeoItemPreRenderEvent.BUS.post(new GeoItemPreRenderEvent<>(renderPassInfo, renderTasks));
    }
    ...
    boolean fireObjectPreRender(RenderPassInfo<R> renderPassInfo, SubmitNodeCollector renderTasks) {
        return !GeoObjectPreRenderEvent.BUS.post(new GeoObjectPreRenderEvent<>(renderPassInfo, renderTasks));
    }
}
