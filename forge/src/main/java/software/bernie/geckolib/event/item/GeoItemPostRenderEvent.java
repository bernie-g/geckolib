 ...
 * @see Post
 */
public record GeoItemPostRenderEvent<T extends Item & GeoAnimatable>
        ...
        implements GeoRenderEvent.Item.Post<T>, RecordEvent {
    public static final EventBus<GeoItemPostRenderEvent> BUS = EventBus.create(GeoItemPostRenderEvent.class);
