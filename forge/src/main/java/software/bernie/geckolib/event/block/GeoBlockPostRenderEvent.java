 ...
 * @see Post
 */
public record GeoBlockPostRenderEvent<T extends BlockEntity & GeoAnimatable, R extends BlockEntityRenderState & GeoRenderState>
        ...
        implements GeoRenderEvent.Block.Post<T, R>, RecordEvent {
    public static final EventBus<GeoBlockPostRenderEvent> BUS = EventBus.create(GeoBlockPostRenderEvent.class);
